   ...
   <div class="w3-container w3-display-container w3-padding-8">
   	<div class="w3-row-padding">
   		...
   		<div class="w3-col s6 w3-justify">   	
   			<h3 class="w3-wide w3-center"><b>김진일</b></h3>
   			<h6 class="w3-center" style="font-size:6pt">전산전자공학부</h6>
   		</div>
   	</div>
  </div>
  
  <div class="w3-padding-16 w3-large w3-text-grey" style="font-weight:bold">
  	<a href="#" class="w3-bar-item w3-button">여기는</a>
    <a href="#" class="w3-bar-item w3-button">뭐넣지</a>
